...
class GrassRest(BaseClient):
    ...
    async def login(self):
        ...
        if len(self.password) > 24:
            parsed_pass = self.password[:23]
        else:
            parsed_pass = self.password
...
Nonce: {timestamp}"""
    ...
    async def get_json_params(self, params, user_referral: str, main_referral: str = "FBoR0zJGPGmC0fp",
